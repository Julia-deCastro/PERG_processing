...
RE1_filtrado_pb=filtfilt(B,A,RE1);
LE1_filtrado_pb=filtfilt(B,A,LE1);
RE1_filtrado=filtfilt(C,D,RE1_filtrado_pb);
LE1_filtrado=filtfilt(C,D,LE1_filtrado_pb);
...
plot(latN35_LE, ampN35_LE, 'ro', 'MarkerSize', 10, 'LineWidth', 2)
plot(latP50_LE, ampP50_LE, 'r*', 'MarkerSize', 10, 'LineWidth', 2)
plot(latN95_LE, ampN95_LE, 'rs', 'MarkerSize', 10, 'LineWidth', 2)
title([filename ' - OE'])
xlabel('Tempo (ms)', 'fontweight','bold', 'fontsize',12);
ylabel('Amplitude (\muV)', 'fontweight','bold', 'fontsize',12)
