...
% Estatísticos
load("assimetria_RE_rp_vector.mat");
load("curtose_RE_rp_vector.mat");
load("entropia_RE_rp_vector.mat");
load("variancia_RE_rp_vector.mat");
...
% Estatísticos
load("assimetria_LE_rp_vector.mat");
load("curtose_LE_rp_vector.mat");
load("entropia_LE_rp_vector.mat");
load("variancia_LE_rp_vector.mat");
...
categoria=[zeros(1,2*length(ampN35_RE_dm_vector)) ...
    ones(1,2*length(ampN35_RE_rp_vector))]';


Amplitude_N35=[ampN35_RE_dm_vector ampN35_LE_dm_vector ...
    ampN35_RE_rp_vector ampN35_LE_rp_vector]';

Latencia_N35=[latN35_RE_dm_vector latN35_LE_dm_vector ...
    latN35_RE_rp_vector latN35_LE_rp_vector]';

Amplitude_P50=[ampP50_RE_dm_vector ampP50_LE_dm_vector ...
    ampP50_RE_rp_vector ampP50_LE_rp_vector]';

Latencia_P50=[latP50_RE_dm_vector latP50_LE_dm_vector ...
    latP50_RE_rp_vector latP50_LE_rp_vector]';

Amplitude_N95=[ampN95_RE_dm_vector ampN95_LE_dm_vector ...
    ampN95_RE_rp_vector ampN95_LE_rp_vector]';

Latencia_N95=[latN95_RE_dm_vector latN95_LE_dm_vector ...
    latN95_RE_rp_vector latN95_LE_rp_vector]';

Amplitude_N35_P50=[PKAmpN35P50_RE_dm_vector PKAmpN35P50_LE_dm_vector ...
    PKAmpN35P50_RE_rp_vector PKAmpN35P50_LE_rp_vector]';

Latencia_N35_P50=[LatPKN35P50_RE_dm_vector LatPKN35P50_LE_dm_vector ...
    LatPKN35P50_RE_rp_vector LatPKN35P50_LE_rp_vector]';

Amplitude_P50_N95=[PKAmpP50N95_RE_dm_vector PKAmpP50N95_LE_dm_vector ...
    PKAmpP50N95_RE_rp_vector PKAmpP50N95_LE_rp_vector]';

Latencia_P50_N95=[LatPKP50N95_RE_dm_vector LatPKP50N95_LE_dm_vector ...
    LatPKP50N95_RE_rp_vector LatPKP50N95_LE_rp_vector]';

PotenciaMedia=[PotMedia_RE_dm_vector PotMedia_LE_dm_vector ...
    PotMedia_RE_rp_vector PotMedia_LE_rp_vector]';

RatioN95P50=[RatioN95P50_RE_dm_vector RatioN95P50_LE_dm_vector...
    RatioN95P50_RE_rp_vector RatioN95P50_LE_rp_vector]';

Acuidade=[acuidade_re_dm_logMar; acuidade_le_dm_logMar;...
    acuidade_re_rp_logMar; acuidade_le_rp_logMar];

AreaP50=[AreaP50_RE_dm_vector AreaP50_LE_dm_vector ...
    AreaP50_RE_rp_vector AreaP50_LE_rp_vector]';

AreaN95=[AreaN95_RE_dm_vector AreaN95_LE_dm_vector ...
    AreaN95_RE_rp_vector AreaN95_LE_rp_vector]';

assimetria = [assimetria_RE_dm_vector assimetria_LE_dm_vector ...
    assimetria_RE_rp_vector assimetria_LE_rp_vector]';

curtose = [curtose_RE_dm_vector curtose_LE_dm_vector ...
    curtose_RE_rp_vector curtose_LE_rp_vector]';

entropia = [entropia_RE_dm_vector entropia_LE_dm_vector ...
    entropia_RE_rp_vector entropia_LE_rp_vector]';

variancia = [variancia_RE_dm_vector variancia_LE_dm_vector ...
    variancia_RE_rp_vector variancia_LE_rp_vector]';
...
% Calculados + Estatíticos
pacientes=table(Amplitude_N35_P50, Latencia_N35_P50, Amplitude_P50_N95, ...
    Latencia_P50_N95, RatioN95P50, ...   
    assimetria, curtose, entropia, variancia, categoria);
